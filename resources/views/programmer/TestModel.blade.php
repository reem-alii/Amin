    ...
    <nav class="nav">
        <div class="main-nav">
            ...
            <ul class="nav-links">
                ...
                <li><a href="/programmer/testmodel" class="active">Test Models</a></li>
            </ul>
        </div>
        <div class="icons">
                        ...
                        <div class="inner bg-white-bone custom-p-3 rounded-4 mb-3">
                            ...
                            <form action="{{route('programmer.getWindstormPrediction')}}" method="post">
                                ...
                                <div class="form-group mb-3 d-flex justify-content-between ">
                                    <input class="form-control text-custom-color w-45" step="0.01" type="number" placeholder="Temperature" name="temperature" id="temperature">
                                    <input class="form-control text-custom-color w-45" step="0.01" type="number" placeholder="Relative Humidity" name="relativeHumidity"
                                        id="relativeHumidity">
                                </div>
                                <div class="form-group mb-3 d-flex justify-content-between ">
                                    <input class="form-control text-custom-color w-45" step="0.01" type="number" placeholder="Pressure" name="pressure" id="pressure">
                                    <input class="form-control text-custom-color w-45" step="0.01" type="number" placeholder="Wind Direction" name="windDirection"
                                        id="windDirection">
                                </div>
                                <div class="form-group mb-3 d-flex justify-content-between ">
                                    <input class="form-control text-custom-color w-45" step="0.01" type="number" placeholder="Precipitattion" name="precipitattion" id="precipitattion">
                    ...
                    <div class="flood col-md-5  ">
                        ...
                        <div class="inner bg-white-bone custom-p-3 rounded-4 mb-3">
                            ...
                            <form action="{{route('programmer.getPrediction')}}" method="post">
                                ...
                                @method('post')
                                <div class="form-group mb-3 d-flex  justify-content-between ">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="jan" id="jan" placeholder="1'st_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="APR" id="APR" placeholder="2'nd_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="JUL" id="JUL" placeholder="3'rd_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="OCT" id="OCT" placeholder="4'th_M">
                                </div>
                                <div class="form-group mb-3 d-flex  justify-content-between ">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="FEB" id="FEB" placeholder="5'th_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="MAY" id="MAY" placeholder="6'th_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="AUG" id="AUG" placeholder="7'th_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="NOV" id="NOV" placeholder="8'th_M">
                                </div>
                                <div class="form-group mb-3 d-flex  justify-content-between ">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="MAR" id="MAR" placeholder="9'th_M">
                                    <input class="form-control text-custom-color w-24" step="0.01" type="number" name="JUN" id="JUN" placeholder="10'th_M">
