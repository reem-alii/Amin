                    ...
                    @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{$user -> address}}</td><!--address-->
                                    <form  method="POST" action="{{route('adminUser.destroy',$user['id'])}}" style="display:inline">
                                    @csrf
                                    @method("delete")
            ...
            <div class="table-container volunteer-table">
                <table>
                    ...
                    @foreach($volunteers as $volunteer)
                        <tr>
                            <td></td>
                            <td>{{$volunteer -> first_name}}  {{$user -> last_name}}</td><!--name-->
                            ...
                            <td>  {{$volunteer->user? $volunteer-> user-> national_id : 'Not Found'}}</td><!--id number-->
                            <td> {{$user -> age}}</td><!--age-->
                            <td>{{$user -> country}}</td><!--country-->
                            <td>{{$user -> address}}</td><!--address-->
                                <form  method="POST" action="{{route('adminUser.destroy',$user['id'])}}" style="display:inline">
