                ...
                <table>
                    ...
                    @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{$user -> id_number}}</td><!--id number-->
            ...
            <div class="table-container volunteer-table">
                <table>
                    ...
                    @foreach($volunteers as $volunteer)
                        ...
                        <tr>
                            <td></td>
                            <td>@foreach($users as $user) @if($volunteer->user_email ==$user->email) {{$user -> id_number}} @endif @endforeach</td><!--id number-->
