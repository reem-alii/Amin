    ...
    <section class="login-container">
        <div class="form-box">
            ...
            <div class="login-form">
                <div class="header">
                        <h2>Sign in</h2>
                        <p>to your account using your email</p>       
                </div> 
                <div class="form">
                    <form action="{{ route('login') }}" method="post" id="Signin-form">
                        ...
                        <div >
                            <a href="{{ route('password.request') }}" class="forgot-pw">Forgot password?</a>
                        </div>      
                        @endif
                        <div class="login-signup">Don't have an account? <a href="/register" id="signup">Signup</a></div>
                    </form>
                </div>
            </div>
        </div>
